	 ...
	 <div class="header">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="biaodi.jsp">标的</a>
                <li><a href="saleground.jsp">拍卖会</a>
                <li><a href="flow.jsp">拍卖流程</a>
                <li><a href="#">我的拍卖</a>
            </ul>
        </div>
        <div class="search">
        ...
        <div class="login">
            <button><a href="login.jsp">登录</a><tton>
            <button><a href="register.jsp">注册</a><tton>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="helps">
            ...
            <div class="help">
                <ul>
                    <h3>关于我们</h3>
                    <li><a href="#">邮编:610101</a>
                    <li><a href="#">客服专线:123456</a>
                    <li><a href="#">联系地址:四川师范大学</a>
                </ul>
            </div>
        </div>
        <div class="others">
