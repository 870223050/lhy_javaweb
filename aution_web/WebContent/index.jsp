	 ...
	 <div class="header">
        ...
        <div class="search">
           ...
           <%
			...
			%>
				<div id="mess" style="color:red;">你好，<%= session.getAttribute("login") %></div>
        ...
        <div class="auction">
            <div class="start-ing">
                ...
                <ul class="auction-wrap clearfix">
                    ...
                    <li class="auction-index">
                        <div class="auction-img">
                            <a href="#"><img src="jpg/auction-house.png" alt="auction-land"></a>
                        </div>
                        <div class="auction-item">
                            <p><a href="#">德州市柞村房产一处</a></p>
                        </div>
                        <div class="auction-money clearfix">
                            <p>当前价:</p>
    ...
    <div class="footer">
        <div class="helps">
            ...
            <div class="help">
                <ul>
                    <h3>支付帮助</h3>
                    <li><a href="#">如何报名交保证金</a></li>
                    <li><a href="#">交保遇到限额</a></li>
                    <li><a href="#">尾款如何支付</a></li>
                </ul>
            </div>
            <div class="help">
                <ul>
                    <h3>常见问题</h3>
                    <li><a href="#">退还保证金</a></li>
                    <li><a href="#">悔拍怎么办</a></li>
                    <li><a href="#">如何处理过户</a></li>
                </ul>
            </div>
            <div class="help">
                <ul>
                    <h3>关于我们</h3>
                    <li><a href="#">邮编:610101</a></li>
                    <li><a href="#">客服专线:123456</a></li>
                    <li><a href="#">联系地址:四川师范大学</a></li>
                </ul>
            </div>
        </div>
        <div class="others">
            <ul>
                <li>京公网安备：1101051611&nbsp;&nbsp;</li>
                <li>备案号：京ICP备13044676号&nbsp;&nbsp;</li>
                <li>拍卖平台网络科技股份有限公司</li>
            </ul>
        </div>
    </div>
</body>
