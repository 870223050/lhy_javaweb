  ...
  <body>
    <form class="form-horizontal" action="updateServlet">
  		...
  		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" placeholder="书本编号" name="categoryId">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-1 control-label">书本名称:</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" placeholder="书本名称" name="title">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" placeholder="上传时间" name="createdate">
			</div>
		</div>
  		<div>
